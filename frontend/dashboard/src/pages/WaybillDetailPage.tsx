...
import { Package, Truck, MapPin, CheckCircle, XCircle, RotateCcw, Ban, ScanLine, AlertTriangle, FileText, User, Shield, Paperclip, Download, Trash2, Upload, ArrowLeftRight, RefreshCw } from 'lucide-react'
import { waybillService, teamService, attachmentService, analyticsService, returnService } from '@/services/api'
import type { ExceptionCode, EventType, WaybillStatus, Attachment, ETAPrediction, ReturnStatus } from '@/types/waybill'
