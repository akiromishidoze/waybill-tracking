  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        ...
        <Link to="/waybills/new" style={{ padding: '0.5rem 1rem', background: '#2563eb', color: '#fff', borderRadius: 6, textDecoration: 'none', fontWeight: 500 }}>
          + New Waybill
        </Link>
      </div>
              ...
              filtered?.map((wb: Waybill) => (
                <tr key={wb.id} style={{ borderTop: '1px solid #f1f5f9', background: wb.slaBreached ? '#fef2f2' : undefined }}>
                  <td style={{ padding: '0.75rem 1rem' }}>
                    <Link to={`/waybills/${wb.id}`} style={{ color: '#2563eb', textDecoration: 'none', fontWeight: 500 }}>
                      {wb.trackingNumber}
                    </Link>
                  </td>
                  ...
                  <td style={{ padding: '0.75rem 1rem' }}>
                    {wb.carrierName ? (
                      <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', padding: '0.25rem 0.5rem', borderRadius: 4, fontSize: '0.75rem', fontWeight: 500, background: '#eff6ff', color: '#2563eb' }}>
                  ...
                  <td style={{ padding: '0.75rem 1rem' }}>
                    {wb.slaBreached ? (
                      <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', padding: '0.2rem 0.6rem', borderRadius: 999, fontSize: '0.7rem', fontWeight: 700, background: '#fef2f2', color: '#dc2626', border: '1px solid #fecaca' }}>
