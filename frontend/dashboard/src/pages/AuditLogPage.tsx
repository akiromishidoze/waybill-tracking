...
const ACTION_COLORS: Record<string, string> = {
  ...
  USER_LOGIN_FAILED: 'var(--status-red)',
  USER_VIEW: 'var(--status-indigo)',
  ROLE_CHANGE: 'var(--status-purple)',
  WAYBILL_VIEW: 'var(--status-cyan)',
  WAYBILL_CREATE: 'var(--status-green)',
  WAYBILL_UPDATE: 'var(--status-amber)',
  WAYBILL_DELETE: 'var(--status-red)',
  WAYBILL_IMPORT: 'var(--status-green)',
  WAYBILL_BATCH_STATUS: 'var(--status-amber)',
  STATUS_UPDATE: 'var(--status-amber)',
  SCAN_CREATE: 'var(--status-cyan)',
...
const ACTION_LABELS: Record<string, string> = {
  ...
  WAYBILL_UPDATE: 'Update Waybill',
  WAYBILL_DELETE: 'Delete Waybill',
  WAYBILL_IMPORT: 'Import Waybills',
  WAYBILL_BATCH_STATUS: 'Batch Status Update',
  STATUS_UPDATE: 'Status Update',
  SCAN_CREATE: 'Create Scan',
